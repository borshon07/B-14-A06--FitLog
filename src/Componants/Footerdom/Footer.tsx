...
export default function Footer() {
  return (
    <footer className="mt-16 border-t border-base-300 bg-base-100">
      <div className="footer mx-auto max-w-[1280px] items-center justify-center justify-items-center gap-3 px-6 py-8 
      text-center sm:footer-horizontal sm:justify-between sm:justify-items-start sm:text-left">
